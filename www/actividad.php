<?php
  ...
  function rellenarEsqui(){
    ...
    $argumentos['imagen2'] = "img/esqui.jpg";
  ...
  function rellenarSenderismo(){
    ...
    $argumentos['imagen2'] = "img/senderismo.jpg";
  ...
  function rellenarSnowboard(){
    ...
    $argumentos['imagen2'] = "img/snowboard.jpg";
  ...
  function rellenarRafting(){
    ...
    $argumentos['imagen2'] = "img/rafting.jpg";
  ...
  function rellenarDescensoBici(){
    ...
    $argumentos['imagen2'] = "img/descenso.jpg";
  ...
  function rellenarParapente(){
    ...
    $argumentos['imagen2'] = "img/parapente.jpg";
  ...
  function rellenarCamping(){
    ...
    $argumentos['imagen2'] = "img/camping.jpg";
  ...
  function rellenarAvistamientoAves(){
    ...
    $argumentos['imagen2'] = "img/aves.jpg";
